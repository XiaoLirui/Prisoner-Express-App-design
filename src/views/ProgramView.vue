...
<template>
  ...
  <div class="container pt-5 pb-5">
    ...
    <!-- Text -->
    <div class="header">
      <div class="title">Prisoner Express Educational Programs</div>
      <div class="quote"> Empower Your Future, Learn Today!</div>
      <div class="instruction">
      </div>
    </div>
    <div>
    <!-- Render Program items -->
    <div class="Program-item" v-for="(item, key) in allProgramItems" :key="key">
      <b-card
        tag="article"
